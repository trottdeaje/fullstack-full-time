...
```During this homework, you will put all this knowledge together to build a web page that will tell your users their local time and allow them to calculate any time from then by entering any number of hours and/or minutes to use. In this homework, you will also use [Moment.js library](https://momentjs.com/) to help you manipulate time data```
...
As shown in the gif belwo, use a combination of Bootstrap and CSS media queries to make your page responsive to different screen sizes.

![Time fron now page responsive overview](./time-from-now-page-responsive-overview.gif)
